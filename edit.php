...
$cn = mysqli_connect("localhost", "root", "", "db_admission");
    ...
    else
    {
        ...
        if($er == 0)
        {
            ...
            photo_Path = '".strip_tags($photoFilePath)."',
            document_Path = '".strip_tags($documentFilePath)."' where id = ".$_GET['id'];
							...
							<div class="row">
								...
								<div class="col-md-6">
									<div class="right-side-form">
										...
										<h5><label for="Caste">division</label></h5>
